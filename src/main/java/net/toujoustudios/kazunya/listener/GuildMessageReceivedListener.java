...
public class GuildMessageReceivedListener extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(@NotNull GuildMessageReceivedEvent event) {
        ...
        if(baseMessage.equalsIgnoreCase("taiwan")) {
            event.getMessage().reply("ATTENTION CITIZEN! 市民请注意!\n" +
                    "\n" +
                    ...
                    "\n" +
                    "为党争光! Glory to the CCP!").queue();
        }

        if(baseMessage.equalsIgnoreCase("among us")) {
