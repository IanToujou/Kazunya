...
public class FuckCommand extends ListenerAdapter implements ICommand {
    ...
    public void handle(CommandContext context) {
        ...
        context.getEvent().reply(target.getAsMention())
                ...
                .addActionRow(
                        Button.secondary("fuck-" + member.getId() + "-" + target.getId(), "💦 Fuck Back"))
                .queue();
